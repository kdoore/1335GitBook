...
* [Assignments](assignments/README.md)
  ...
  * [Assignment 2: Functional Emotions](assignments/assignment-2-functions-of-color.md)
...
* [PShape Objects](project-1/pshape/README.md)
  * [Example Code: PShape](project-1/pshape/sept-16-code/README.md)
    * [Inspiration](project-1/pshape/sept-16-code/diagram-and-art-expression.md)
...
* [Pattern Preview - Transforms: Translate & Scale](grid-based-designs/pattern-preview-transforms-translate-and-scale.md)

## Project 2

* [Project 2 - 2D Arrays for Gradient Logic](project-2/transforms-for-region-logic/README.md)
  * [2D Array Grid with Labels](project-2/transforms-for-region-logic/2d-array-grid-with-labels.md)
* [Grid Patterns using 2D Array Indexes: i, j](project-2/grid-patterns-using-2d-array-indexes-i-j/README.md)
  * [Example Class Code](project-2/grid-patterns-using-2d-array-indexes-i-j/march-11-class-code.md)
* [lerpColor\( \)  and map\( \) Functions](project-2/lerpcolor-and-map.md)
* [Demo Lerp Colors](project-2/demo-lerp-colors.md)
* [2D Arrays with lerpColor](project-2/2d-arrays-with-lerpcolor.md)
* [Create PShape 2D Array](project-2/create-pshape-2d-array.md)
* [Function: Populate2DArray\( \)](project-2/function-populategradientgrid.md)
* [Function: DisplayShapeMatrix\(\)](project-2/function-displayshapematrix.md)
* [Transforms for Position, Rotation, Scale of ShapeMatrix Elements](project-2/transforms-for-position-rotation-scale-of-shapematrix-elements.md)
* [Project 2 - Steps](project-2/project-2-design-using-2d-pshape-array-lerpcolor-processing-transform-functions.md)
* [Animation for ShapeMatrix](project-2/animation-for-shapematrix/README.md)
  * [Animation w/Noise](project-2/animation-for-shapematrix/animation-wnoise.md)
...
* [Modeling Buttons: States and Events](object-oriented-programming/modelingstates_and_events_md.md)
* [OOP - Inheritance](object-oriented-programming/object_inheritance.md)
* [OOP - Polymorphism](object-oriented-programming/oop-polymorphism.md)
* [Child-Class: PImageButton](object-oriented-programming/pimagebutton.md)
* [PShape - SVG Objects](object-oriented-programming/pshape_-_svg_objects.md)
* [Menu of Buttons](object-oriented-programming/menu_buttons.md)
* [ButtonGroup - Final Version](object-oriented-programming/arrays_of_objects.md)
* [Slider Controller](object-oriented-programming/slider_controller.md)
* [UML Class Diagram](object-oriented-programming/uml-class-diagram.md)
...
* [Project 3 - Class Definitions](project-3/project-3-class-definitions/README.md)
  ...
  * [ButtonGroup](project-3/project-3-class-definitions/buttongroup.md)
  * [Pattern](project-3/project-3-class-definitions/pattern/README.md)
    * [PShapes - SVG, Vertex Shapes](project-3/project-3-class-definitions/pattern/pshapes-svg-vertex-shapes.md)
    * [Setting Colors For Patterns](project-3/project-3-class-definitions/pattern/setting-colors-for-patterns.md)
